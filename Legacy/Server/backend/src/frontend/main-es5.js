...
var FormdataUploadComponent = /** @class */ (function () {
    function FormdataUploadComponent(formBuilder, http) {
    ...
    FormdataUploadComponent.prototype.ngOnInit = function () {
    ...
    FormdataUploadComponent.prototype.onSubmit = function () {
        ...
        var uploadURL = this.SERVER_URL + "/upload";
        this.http.post(uploadURL, formData).subscribe(function (res) {
            _this.uploadResponse = "Barco " + _this.form.get('vessel').value + ": \n";
            _this.uploadResponse += "----------------\n";
            _this.uploadResponse += res;
            _this.form.get('filename').setValue('');
            _this.form.get('vessel').setValue('');
